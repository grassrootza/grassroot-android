...
//        Log.d(TAG,"ContactsModel photo not found for contact "+contactUri.toString()
//            +": "+e.toString());
          }
        }
      finally
...
//            +": "+e.toString());
   ...
   * platform version.
   *
   * @param photoData For platforms prior to Android 3.0, provide the ContactsModel._ID column value.
   *                  For Android 3.0 and later, provide the ContactsModel.PHOTO_THUMBNAIL_URI value.
...
//        {
//        Log.d(TAG,"ContactsModel photo thumbnail not found for contact "+photoData
//            +": "+e.toString());
//        }
      }
    finally
