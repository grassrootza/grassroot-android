...
public class ContactsAdapter extends ArrayAdapter<Contact> implements SectionIndexer {
  ...
  public View getView(final int position, final View convertView, final ViewGroup parent) {
    ...
    if (convertView != null) {
      try {
        ...
        throw new UnsupportedOperationException(
            "Error! Contact list adapter passed wrong kind of view");
      }
    } else {
    ...
    viewHolder.ivContactSelected.setImageResource(
        contact.isSelected ? R.drawable.btn_checked : R.drawable.btn_unchecked);
  ...
  public void toggleSelected(int position, View view) {
    ...
    holder.ivContactSelected.setImageResource(
        contact.isSelected ? R.drawable.btn_checked : R.drawable.btn_unchecked);
  }
  ...
  public void setSelected(int contactPosition, int selectedNumberIndex, View viewHolder) {
    ...
    contact.selectedNumber = contact.numbers.get(selectedNumberIndex).toString();
    contact.selectedMsisdn = contact.msisdns.get(selectedNumberIndex).toString();
    contact.isSelected = true;
    ContactViewHolder holder =
        (ContactViewHolder) viewHolder.getTag(); // just do notify item changed ??
  ...
  @Override public int getPositionForSection(int i) {
