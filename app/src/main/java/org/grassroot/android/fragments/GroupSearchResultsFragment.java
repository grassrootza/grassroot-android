        ...
        GrassrootRestService.getInstance().getApi().search(mobile, code, searchTerm)
                .enqueue(new Callback<GroupSearchResponse>() {
                    ...
                    public void onFailure(Call<GroupSearchResponse> call, Throwable t) {
                        progressDialog.dismiss();
                        ErrorUtils.connectivityError(GroupSearchResultsFragment.this, R.string.error_no_network, new NetworkErrorDialogListener() {
                            @Override
                ...
                groupModel.getId(), groupModel.getDescription()).enqueue(new Callback<GenericResponse>() {
                    ...
                    public void onResponse(Call<GenericResponse> call, Response<GenericResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(GroupSearchResultsFragment.this);
                            ...
                            final String errorMsg = ErrorUtils.serverErrorText(response.errorBody(), GroupSearchResultsFragment.this);
