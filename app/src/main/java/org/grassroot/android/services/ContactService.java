...
public class ContactService {
    ...
    private void loadContactMap() {
        ...
        try {
            ...
            Cursor contactHolder = cr.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, projectionForPhones, null, null, null);

            if (contactHolder != null) {
                final int keyCol = contactHolder.getColumnIndexOrThrow(ContactsContract.CommonDataKinds.Phone.CONTACT_ID);
            ...
            final String queryString = ContactsContract.CommonDataKinds.StructuredName.CONTACT_ID + " IN (" + ids + ") AND "
                    + ContactsContract.Data.MIMETYPE + " = '" + ContactsContract.CommonDataKinds.StructuredName.CONTENT_ITEM_TYPE + "'";

            contactHolder = cr.query(ContactsContract.Data.CONTENT_URI, projectionForNames, queryString, null, null);
            ...
            if (contactHolder != null) {
                while (contactHolder.moveToNext()) {
                    ...
                    if (contact != null && TextUtils.isEmpty(contact.firstName) && TextUtils.isEmpty(contact.lastName)) {
            ...
            try {
                final String selection = ContactsContract.RawContacts.ACCOUNT_TYPE + " = " + "'com.whatsapp'";
                contactHolder = cr.query(ContactsContract.RawContacts.CONTENT_URI, projectionForWhatsApp, selection, null, null);
                if (contactHolder != null) {
                    while (contactHolder.moveToNext()) {
                ...
                Log.e(TAG, "ERROR! Something went wrong in attempting to read WhatsApp contacts ... trace ...");
